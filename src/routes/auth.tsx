      ...
      <div className="relative mx-auto flex min-h-screen max-w-md flex-col items-center justify-center px-6">
        ...
        <div className="glass w-full rounded-2xl p-8">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {mode === "signin" ? "Sign in to your document library." : "Start chatting with your documents."}
          </p>

          <button
            onClick={google}
            disabled={loading}
            className="mt-6 flex w-full items-center justify-center gap-3 rounded-md border border-border bg-surface px-4 py-2.5 text-sm font-medium hover:bg-surface-elevated disabled:opacity-50"
          >
